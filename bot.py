...
# ==================== الإعدادات الأساسية ====================
API_TOKEN = "8009086918:AAGSWoTwb_FAmII3frv0CkHetCIxI0bkVN4"
ADMIN_ID = 7947679527
DEVELOPER = "@ggzh9"
...
def get_file_link(file_name: str, user_id: int) -> str:
    return f"https://kayo866498.pythonanywhere.com/{get_current_folder(user_id)}/{file_name}"
...
def main_menu_keyboard(user_id: int):
    ...
    # الأعضاء العاديون يرون فقط هذه الأزرار
    keyboard.add(
...
if __name__ == "__main__":
    ...
    WEBHOOK_URL = "https://kayo866498.pythonanywhere.com/webhook"
